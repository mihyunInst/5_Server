...
<header>
	...
	<section>
	    <a href="${pageContext.request.contextPath}">
	        ...
	        <img src="${pageContext.request.contextPath}/resources/images/logo.jpg" id="home-logo">
...
<nav>
    <ul>
        <li><a href="${pageContext.request.contextPath}/board/list?type=1">공지사항</a></li>

        <li><a href="${pageContext.request.contextPath}/board/list?type=2">자유 게시판</a></li>

        <li><a href="${pageContext.request.contextPath}/board/list?type=3">질문 게시판</a></li>
